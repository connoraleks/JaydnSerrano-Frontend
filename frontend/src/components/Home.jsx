const Home = ({home}) => {
    return (
        <div ref={home} className="h-screen w-full relative overflow-hidden box-border">
            <div className="w-full mt-20 sm:mt-24 md:mt-0 sm:w-1/2 h-full flex flex-col justify-start xl:justify-center p-16 lg:ml-12 xl:ml-24" style={{transition: "all 0.55s ease"}}>
