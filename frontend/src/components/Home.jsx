const Home = ({home}) => {
    return (
        <div ref={home} className="h-screen w-full relative overflow-hidden box-border">
            ...
            <img className="h-3/5 md:h-4/5 2xl:h-full w-min absolute -z-10 left-0 right-0 bottom-0 ml-auto mr-4 lg:mr-16" style={{transition: "all 0.55s ease", maxWidth: "85%"}} src={process.env.PUBLIC_URL + '/assets/home.png'}  alt="jaydn headshot"/>
        </div>
    );
}
